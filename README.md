...
* You need to edit your machine's local host file. Add the entry
  `10.33.36.11 pmmitest.dev`
* Run `vagrant up --provision` to build the environment.
* ssh in with `vagrant ssh`
* Navigate to `/var/www/sites/pmmitest.dev`.
* PARTY!!!
...
* `build/ref/pmmitest.sql`
* `build/ref/pmmitest.sql.gz`
...
cd /var/www/sites/pmmitest.dev        # go to the sync'ed folder on the box
